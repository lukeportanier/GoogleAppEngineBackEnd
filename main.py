...
def GetResults():
    ...
    smallest_largest_message = f"<p>{smallest_number} was the smallest number generated by the system, it was generated by Instance: {smallest_instance}.</p><br><br><p>{largest_number} was the largest number generated by the system, it was generated by Instance: {largest_instance}.</p>"
